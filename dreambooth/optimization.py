...
from extensions.sd_dreambooth_extension.dreambooth.cyclic_cosine_decay_lr import (
    CyclicCosineDecayLR,
)
...
class SchedulerType(Enum):
    ...
    CYCLIC_COSINE_DECAY = "cyclic_cosine_decay"


def get_cyclic_cosine_decay_scheduler(
    optimizer: Optimizer,
    init_decay_lr=0.01,
    restart_interval=30,
    restart_lr=0.06,
    ...
    Args:
        ...
        init_decay_lr (`float`, *optional*, defaults to 0.01):
                The initial learning rate to use after the number of max iterations is reached.
        restart_interval (`int`, *optional*, defaults to 30):
                The number of steps for the warmup phase.
        restart_lr (`float`, *optional*, defaults to 0.01):
                The minimum learning rate to use after the number of max iterations is reached.
        warmup_epochs (`int`, *optional*, defaults to 0):
                The number of steps for the warmup phase.
        warmup_start_lr (`float`, *optional*, defaults to 0.0):
                The minimum learning rate to use after the number of max iterations is reached.

        Return:
            `extensions.sd_dreambooth_extension.dreambooth.cyclic_cosine_decay_lr  with the appropriate schedule.
    """
    return CyclicCosineDecayLR(
        optimizer,
        init_decay_lr,
        restart_interval,
        restart_lr,
...
def get_scheduler(
    ...
    if name == SchedulerType.CYCLIC_COSINE_DECAY:
