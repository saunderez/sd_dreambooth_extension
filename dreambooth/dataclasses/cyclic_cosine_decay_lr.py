# Borrowed from https://github.com/abhuse/cyclic-cosine-decay/
# Thanks to abhuse
s
...
class CyclicCosineDecayLR(_LRScheduler):
    def __init__(
        self,
        optimizer,  # The optimizer that is being used for training
        init_decay_epochs,  # The number of epochs to decay the learning rate after
        min_decay_lr,  # The minimum learning rate to decay to
        restart_interval=None,  # The number of epochs to wait before restarting the learning rate decay
        restart_interval_multiplier=None,  # The multiplier to use when restarting the learning rate decay
        restart_lr=None,  # The learning rate to restart the learning rate decay at
        warmup_epochs=None,  # The number of epochs to warmup the learning rate for
        warmup_start_lr=None,  # The learning rate to start the warmup at
        last_epoch=-1,  # The last epoch that the learning rate was at
    ):
        """
